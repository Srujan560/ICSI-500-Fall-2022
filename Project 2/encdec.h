...
void decode(char* binaryFile,char* towrite){
    ...
    // close(fd);
    //     // printf("sise %d\n",r);
    char* arr[]={"dec",binaryFile,towrite,NULL};
    execv("dec",arr);
    fprintf(stderr,"Fail to decode method From Libary\n");
...
void parityremove(char *fname,char *output){
    ...
    // fclose(nbin);
    // printf("All Done\n");
    char* arr[]={"prm",fname,output,NULL};
    execv("prm",arr);
    fprintf(stderr,"Fail to parityremoved method From Libary\n");
}
/**
...
void decodeAndUpperCase(char* binaryFile,char* towrite){
    ...
    // close(fd);
    //     // printf("sise %d\n",r);
    char* arr[]={"decodeu",binaryFile,towrite,NULL};
    execv("decodeu",arr);
